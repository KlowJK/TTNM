...
document.addEventListener("DOMContentLoaded", function () {
  ...
  datatables.forEach(datatable => {
    new simpleDatatables.DataTable(datatable, {
      perPage: 10, // vẫn phân trang, nhưng tắt chọn số lượng
      searchable: false, // tắt ô tìm kiếm
      perPageSelect: false, // tắt dropdown chọn số dòng mỗi trang
      info: false, // tắt thông tin hiển thị số dòng
      labels: {
        placeholder: "Tìm kiếm...",
        perPage: "Hiển thị",
        noRows: "Không có dữ liệu",
        info: "Hiển thị từ {start} đến {end} trong tổng {rows} mục"
      },
      columns: [
        {
          select: 0, // Cột STT
